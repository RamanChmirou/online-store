...
import model.discount.FixedAmountDiscount;
...
public class TestDataGenerator {
    public static final Map<String, Discount> DISCOUNTS = Map.of(
            "PNEWYEAR30", new PercentageDiscount(new BigDecimal("0.30")),
            "FANEWYEAR100", new FixedAmountDiscount(new BigDecimal("100"))
    );

    public static void addTestData(ProductService productService) {
